...
const onSubmitHandler = async (event) =>{
    ...
    formData.append("prepTime", data.prepTime)//add preparation time
  ...
  return (
    <div className='add'>
        <form className='flex-col' onSubmit={onSubmitHandler}>
            ...
            <div className='add-category-price'>
                <div className='add-category flex-col'>
                    ...
                    <select onChange={onChangeHandler} value={data.category} name='category'>
                        ...
                        <option value="Main Course">Mian Course</option>
                    </select>
                </div>
            ...
            {/* add preapartime time feild */}
            <div className='add-prep-time flex-col'>
          <p>Preparation time (in minutes)</p>
          <input onChange={onChangeHandler} value={data.prepTime} type='Number' name='prepTime' placeholder='e.g., 20'></input>
        </div>
